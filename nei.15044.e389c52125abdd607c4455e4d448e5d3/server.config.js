...
module.exports = {
    /* 根目录 */
    webRoot: '/Users/joury/ego/public/',
    /* 视图目录 */
    viewRoot: '/Users/joury/ego/public/html/',
    /* 路由 */
    routes: {
...
//      "POST /api/login": { path: 'post/api/login/data', id: 28516, group: '用户' },
    ...
    /* 同步模块mock数据路径 */
    mockTpl: '/Users/joury/ego/mock.data/template/',
    /* 异步接口mock数据路径 */
    mockApi: '/Users/joury/ego/mock.data/interface/',
    /* 是否修改代理的host */
    changeOrigin: true,
    /* 模板后缀 */
    viewExt: '.html',
