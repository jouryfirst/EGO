...
!function(window,undefined){
  ...
  function Modal(options){
   ...
   // this.wrap = this.container.querySelector('.modal_wrap');
    ...
    //this.on('confirm', this.showContent.bind(this));
  ...
  extend(Modal.prototype, {
    ...
    showContent: function (item) {
            ...
            //this.confirmCallBack = item.confirmCallBack || console.log('没有回调事件');
            this.show();
        },
  ...
  //     初始化事件
    _initEvent: function(){
    		...
    		//this.closebtn.addEventListener('click',this._onCancel.bind(this));
